...
diff -r "$RS_OUT" "$JS_OUT"
echo "shaclc conformance identity: PASS (valid+rdf12 x {strict,ext} x {one-shot,push,write+reparse BYTES}, extended accept/strict-reject, negatives; gen-rs == gen-js)"
